...
### Microwave/WiFi Safety Comparison
The reason people are not "cooked" by WiFi, despite using similar frequencies to microwaves, is related to power levels:
...
| **Wavelength ($\lambda$)**       | **~12.5 cm**                                                         | **~6 cm**                                     |
...
A **Personal Area Network (PAN)** refers to a network created between devices in an individual's immediate surroundings, typically within few meters. It connects personal devices such as smartphones, tablets, and IoT.

Examples of technologies used in PANs: **Infrared (IR)**, **Radio-Frequency identification (RFID)**, **Near Field Communication (NFC)**, **Bluetooth**.
